...
const translations: Record<Locale, Record<string, TranslationValue>> = {
  en: {
    ...
    createCommunity: {
      ...
      validationCommunityNameFormat: "Community name can contain only letters, numbers, spaces, and dashes",
      ...
      validationAdminNameFormat: "Admin name can contain only letters and spaces",
    ...
    communityDetails: {
      ...
      adminDetailsDescription: "Profile and account information for this community admin.",
      openAdminDetails: "Open admin details",
      ...
      noAdminAssigned: "No admins are assigned to this community yet.",
      adminLoadFailed: "Admin details could not be loaded.",
      inviteAdminBadge: "Invite Admin",
      assignCommunityAdmin: "Invite or Assign Community Admins",
      inviteAdminSubtitle: "Use the form below to invite another admin, or assign users from the list.",
      pending: "Pending",
      fullName: "Full Name",
      ...
      executiveMembersNote: "Community executive members list with assigned roles.",
      executiveDetailsTitle: "Executive Member Details",
      executiveDetailsDescription: "Profile and assignment information for this executive member.",
      openExecutiveDetails: "Open executive member details",
      noExecutiveMembers: "No executive members found for this community.",
      fetchExecutiveMembersFailed: "Failed to fetch executive members",
      fetchMoreExecutiveMembersFailed: "Failed to fetch more executive members",
      loadMoreExecutiveMembers: "Load More Executive Members",
      executiveRole: "Executive Role",
      assignedAt: "Assigned At",
      unassignExecutive: "Unassign Executive",
      unassigningExecutive: "Unassigning...",
      unassignExecutiveDialogTitle: "Unassign this executive?",
      unassignExecutiveDialogDescription: "This removes the executive assignment and sets the membership role back to MEMBER.",
      unassignExecutiveSuccess: "Executive unassigned successfully.",
      unassignExecutiveFailed: "Failed to unassign executive.",
      verificationStatus: "Verification Status",
      rejectionReason: "Rejection Reason",
      userDetailsTitle: "User Details",
      userDetailsDescription: "Profile and account information for this community member.",
      openUserDetails: "Open user details",
      memberBadge: "Member",
      communityUsersAdminNote: "Admins are fetched separately and can also appear in this users list.",
      ...
      updatingAdminDetails: "Updating Admin...",
      editAdminDetailsHint: "Edit details carefully. Changes are reflected immediately for this community.",
      emailChangeResendHint: "Changing email will resend the invite because this admin has not joined yet.",
      mobileNumberHint: "Use format 03XXXXXXXXX.",
      adminUpdateSuccess: "Community admin details updated successfully.",
      adminUpdateFailed: "Failed to update admin details.",
      invalidEmail: "Please enter a valid email address.",
      adminContactRequired: "Please provide at least one contact: email or mobile number.",
      removeAdmin: "Remove Admin",
      removingAdmin: "Removing...",
      removeAdminDialogTitle: "Remove this admin?",
      removeAdminDialogDescription: "This will remove the admin role from this community user.",
      ...
      adminUserActionsHiddenHint: "This user is currently a community admin. Remove admin role first, then assign, status toggle, and delete options will appear.",
      ...
      deleteUserDialogDescription: "This action cannot be undone. The user will be permanently deleted.",
  ...
  ur: {
    ...
    createCommunity: {
      ...
      validationCommunityNameFormat: "کمیونٹی کے نام میں صرف حروف، اعداد، اسپیس اور ڈیش ہو سکتے ہیں",
      ...
      validationAdminNameFormat: "ایڈمن کے نام میں صرف حروف اور اسپیس ہو سکتے ہیں",
    ...
    communityDetails: {
      ...
      adminDetails: "ایڈمن کی تفصیل",
      adminDetailsTitle: "ایڈمن کی تفصیل",
      adminDetailsDescription: "اس کمیونٹی ایڈمن کی پروفائل اور اکاؤنٹ معلومات۔",
      openAdminDetails: "ایڈمن کی تفصیل کھولیں",
      invitePending: "دعوت زیرِ التوا",
      joined: "شامل ہو گیا",
      email: "ای میل",
      phone: "فون",
      housePlot: "گھر/پلاٹ",
      familyMembers: "فیملی ممبرز",
      bio: "بایو",
      ...
      noAdminAssigned: "اس کمیونٹی کو ابھی تک کوئی ایڈمن تفویض نہیں۔",
      adminLoadFailed: "ایڈمن کی تفصیل لوڈ نہیں ہو سکی۔",
      inviteAdminBadge: "ایڈمن کو دعوت دیں",
      assignCommunityAdmin: "کمیونٹی ایڈمنز کو دعوت دیں یا تفویض کریں",
      inviteAdminSubtitle: "نیچے فارم سے ایک اور ایڈمن کو دعوت دیں، یا یوزرز کی فہرست سے تفویض کریں۔",
      pending: "زیرِ التوا",
      fullName: "پورا نام",
      ...
      executiveMembers: "ایگزیکٹو ممبرز",
      executiveMembersNote: "تفویض کردہ رولز کے ساتھ کمیونٹی ایگزیکٹو ممبرز کی فہرست۔",
      executiveDetailsTitle: "ایگزیکٹو ممبر کی تفصیل",
      executiveDetailsDescription: "اس ایگزیکٹو ممبر کی پروفائل اور تفویضی معلومات۔",
      openExecutiveDetails: "ایگزیکٹو ممبر کی تفصیل کھولیں",
      noExecutiveMembers: "اس کمیونٹی کے لیے کوئی ایگزیکٹو ممبر نہیں ملا۔",
      fetchExecutiveMembersFailed: "ایگزیکٹو ممبرز حاصل نہیں ہو سکے",
      fetchMoreExecutiveMembersFailed: "مزید ایگزیکٹو ممبرز حاصل نہیں ہو سکے",
      loadMoreExecutiveMembers: "مزید ایگزیکٹو ممبرز لوڈ کریں",
      executiveRole: "ایگزیکٹو رول",
      assignedAt: "تفویض کی تاریخ",
      unassignExecutive: "ایگزیکٹو ہٹائیں",
      unassigningExecutive: "ہٹایا جا رہا ہے...",
      unassignExecutiveDialogTitle: "کیا یہ ایگزیکٹو ہٹائیں؟",
      unassignExecutiveDialogDescription: "اس سے ایگزیکٹو اسائنمنٹ ختم ہو جائے گی اور ممبرشپ رول دوبارہ MEMBER پر آ جائے گا۔",
      unassignExecutiveSuccess: "ایگزیکٹو کامیابی سے ہٹا دیا گیا۔",
      unassignExecutiveFailed: "ایگزیکٹو نہیں ہٹایا جا سکا۔",
      verificationStatus: "توثیقی اسٹیٹس",
      rejectionReason: "مسترد ہونے کی وجہ",
      userDetailsTitle: "یوزر کی تفصیل",
      userDetailsDescription: "اس کمیونٹی ممبر کی پروفائل اور اکاؤنٹ معلومات۔",
      openUserDetails: "یوزر کی تفصیل کھولیں",
      memberBadge: "ممبر",
      communityUsersAdminNote: "ایڈمنز الگ سے حاصل کیے جاتے ہیں اور اسی یوزرز فہرست میں بھی نظر آ سکتے ہیں۔",
      ...
      updateAdminDetails: "ایڈمن کی تفصیل اپڈیٹ کریں",
      updatingAdminDetails: "ایڈمن اپڈیٹ ہو رہا ہے...",
      editAdminDetailsHint: "تفصیل احتیاط سے اپڈیٹ کریں۔ تبدیلیاں اس کمیونٹی میں فوراً لاگو ہوں گی۔",
      emailChangeResendHint: "ای میل تبدیل کرنے پر دعوت دوبارہ بھیجی جائے گی کیونکہ یہ ایڈمن ابھی شامل نہیں ہوا۔",
      mobileNumberHint: "فارمیٹ 03XXXXXXXXX استعمال کریں۔",
      adminUpdateSuccess: "کمیونٹی ایڈمن کی تفصیل کامیابی سے اپڈیٹ ہو گئی۔",
      adminUpdateFailed: "ایڈمن کی تفصیل اپڈیٹ نہیں ہو سکی۔",
      invalidEmail: "درست ای میل ایڈریس درج کریں۔",
      adminContactRequired: "براہِ کرم کم از کم ایک رابطہ فراہم کریں: ای میل یا موبائل نمبر۔",
      removeAdmin: "ایڈمن ہٹائیں",
      removingAdmin: "ہٹایا جا رہا ہے...",
      removeAdminDialogTitle: "کیا یہ ایڈمن ہٹائیں؟",
      removeAdminDialogDescription: "اس یوزر سے اس کمیونٹی کی ایڈمن رول ہٹا دی جائے گی۔",
      removeAdminSuccess: "ایڈمن کامیابی سے ہٹا دیا گیا۔",
      removeAdminFailed: "ایڈمن نہیں ہٹایا جا سکا۔",
      ...
      adminUserActionsHiddenHint: "یہ یوزر اس وقت کمیونٹی ایڈمن ہے۔ پہلے ایڈمن رول ہٹائیں، پھر ایڈمن تفویض، اسٹیٹس ٹوگل اور حذف کے آپشنز نظر آئیں گے۔",
      toggleUserStatus: "فعال / غیر فعال",
      userStatusUpdateSuccess: "یوزر اسٹیٹس کامیابی سے اپڈیٹ ہو گیا۔",
      userStatusUpdateFailed: "یوزر اسٹیٹس اپڈیٹ نہیں ہو سکا۔",
      deleteUser: "یوزر حذف کریں",
      deletingUser: "حذف ہو رہا ہے...",
      deleteUserDialogTitle: "کیا یہ یوزر حذف کریں؟",
      deleteUserDialogDescription: "یہ عمل واپس نہیں ہو سکتا۔ یوزر مستقل حذف ہو جائے گا۔",
      userDeleteSuccess: "یوزر کامیابی سے حذف ہو گیا۔",
      userDeleteFailed: "یوزر حذف نہیں ہو سکا۔",
